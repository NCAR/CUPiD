...
Furthermore, to clear the generated notebooks folder which was generated by the cupid-run and cupid-build commands, you can run the following command:

``` bash
$ cupid-clear config.yml 
```

This will clear the computed notebooks folder which is at the location pointed to by the run_dir variable in the config.yml file. 
