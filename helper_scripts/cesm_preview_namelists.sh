...
# and ./preview_namelist is called from the case. It creates the config_*.yml
# files that CUPiD will use to run -- BUT DOES NOT CUPID itself.

# A future development could be to turn this into python code that's used
