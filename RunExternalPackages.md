...
```bash
qinteractive -l select=1:ncpus=12:mem=120GB -l walltime=08:00:00
```
Set up environment for external diagnostics:
``` bash
conda activate cupid-analysis
module load nco  # currently necessary for ADF/LDF
```
