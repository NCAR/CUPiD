...
climo_path = (
    "/glade/derecho/scratch/dbailey/archive/" + case1 + "/ocn/proc/tseries/day_1/"
)

ds1 = xr.open_dataset(
    climo_path + case1 + ".pop.h.nday1." + var1 + ".20080102-20211231.nc",
)
ds2 = xr.open_dataset(
    climo_path + case1 + ".pop.h.nday1." + var2 + ".20080102-20211231.nc",
)
